...
EXPERIMENT_NAME=large_conll2009+conll2012_10-percent

classy train generation data/compositional/conll2009+conll2012/10-percent \
    -n $EXPERIMENT_NAME \
    --profile large_conll2009+conll2012 \
    --fp16 \
