...
EXPERIMENT_NAME=large_conll2012+framenet17_10-percent

classy train generation data/compositional/conll2012+framenet17/10-percent \
    -n $EXPERIMENT_NAME \
    --profile large_conll2012+framenet17 \
    --fp16 \
