mkdir data/conll2009_conll2012
...
PYTHONPATH=. python scripts/preprocessing/merge_datasets.py \
  ...
  --compositional-tokens conll2009 conll2012 \
  --output-path data/conll2009_conll2012/train.srl
...
PYTHONPATH=. python scripts/preprocessing/merge_datasets.py \
  ...
  --datasets-identifier conll2009 conll2012 \
  --compositional-tokens conll2009 conll2012 \
  --output-path data/conll2009_conll2012/validation.srl
...
PYTHONPATH=. python scripts/preprocessing/merge_datasets.py \
  ...
  --datasets-identifier conll2009 conll2012 \
  --compositional-tokens conll2009 conll2012 \
  --output-path data/conll2009_conll2012/test.srl
